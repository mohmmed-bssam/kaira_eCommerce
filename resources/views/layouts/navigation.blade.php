            ...
            <div class="flex">
                ...
                <div class="hidden space-x-3 sm:-my-px sm:ms-6 sm:flex sm:items-center">
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('dashboard.blog-categories.index')">
                                {{ __('Categories') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('dashboard.blog-posts.index')">
                                {{ __('Posts') }}
                            </x-dropdown-link>
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('dashboard.payments')">
                                {{ __('admin.payments') }}
                            </x-dropdown-link>

                            <x-dropdown-link :href="route('dashboard.customers')">
                                {{ __('Customers') }}
                            </x-dropdown-link>
